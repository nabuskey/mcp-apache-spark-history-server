...
class Configuration:
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "http://localhost:18080/api/v1" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("spark_history_mcp.api_client")
        ...
        return [
            {
                ...
                'description': "Local Spark History Server",
            }
        ]
